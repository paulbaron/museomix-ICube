...
public abstract class Node
{
	...
	Microsoft.Xna.Framework.Point mLocation;			// node position, relative to the origin
	...
	public Node()
    {
        mLocation = new Microsoft.Xna.Framework.Point();
		mDiagram = null;
...
public class MuseoNode : Node
{
	...
	public MuseoNode(Color colour, Model model)
    : base()
    {
        _model = model;
        _colour = colour;
